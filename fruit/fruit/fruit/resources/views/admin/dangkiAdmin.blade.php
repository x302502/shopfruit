                      ...
                      @endif
                        ...
                        <form role="form" action="dangki" method="POST">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Nhập lại mật khẩu" name="rep_password" type="password" value="">
                                </div>
                                <button type="submit" class="btn btn-lg btn-success btn-block">Đăng kí</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
